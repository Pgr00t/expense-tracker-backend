...
class ExpenseViewSet(viewsets.ModelViewSet):
    ...
    def summary(self, request):
        ...
        return Response({"total_amount": total, "category_breakdown": breakdown})
    ...
    def convert_currency(self, request):
        ...
        if base_currency == target_currency:
            return Response(
                {"converted_amount": val, "rate": 1.0, "currency": target_currency}
            )
        ...
        try:
            ...
            if response.status_code == 404:
                return Response(
                    {"error": f"Base currency {base_currency} not supported"},
            ...
            if data.get("result") == "success" and "rates" in data:
                ...
                return Response(
                    {"error": "Unexpected response from ExchangeRate-API"},
